        ...
        ****/
        ...
        public void save() {
            ...
            if (SaveName != null) {
                ...
                s_env.Helper.Data.WriteJsonFile<LocalConfig>(Path.Combine("psconfigs", $"{SaveName}.json"), this);
            } else if (s_perSaveConfigPath != null) {
                //s_env.Monitor.Log("Save the config:"+ s_perSaveConfigPath);
                s_env.Helper.Data.WriteJsonFile<LocalConfig>(s_perSaveConfigPath, this);
            }
        }
    }
}
